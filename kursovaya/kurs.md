...
**Среда исполнения (Platform / Arch)** — совокупность архитектурных параметров (архитектура CPU, libc, целевая ОС), для которой производится сборка. Система кеширует артефакты отдельно для каждой уникальной комбинации параметров платформы.
